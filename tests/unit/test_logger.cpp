...
protected:
    void SetUp() override {
        ...
        cms::Logger::Instance().SetLogLevel(cms::LogLevel::Info);
    }
...
TEST_F(LoggerTest, SingletonInstance) {
    auto& logger1 = cms::Logger::Instance();
    auto& logger2 = cms::Logger::Instance();
...
TEST_F(LoggerTest, LogLevelGetSet) {
    auto& logger = cms::Logger::Instance();
...
TEST_F(LoggerTest, LoggingMacros) {
    cms::Logger::Instance().SetLogLevel(cms::LogLevel::Debug);
