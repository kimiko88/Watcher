...
TEST_F(ProtocolTest, CommandTypeToString) {
    ...
    EXPECT_EQ(CommandTypeToString(CommandType::SCREENSHOT_REQUEST), "SCREENSHOT_REQUEST");
    EXPECT_EQ(CommandTypeToString(CommandType::SCREENSHOT_DATA), "SCREENSHOT_DATA");
    ...
    EXPECT_EQ(CommandTypeToString(CommandType::SCREEN_BROADCAST), "SCREEN_BROADCAST");
...
TEST_F(ProtocolTest, StringToCommandType) {
    ...
    EXPECT_EQ(StringToCommandType("SCREENSHOT_REQUEST"), CommandType::SCREENSHOT_REQUEST);
    EXPECT_EQ(StringToCommandType("SCREENSHOT_DATA"), CommandType::SCREENSHOT_DATA);
    ...
    EXPECT_EQ(StringToCommandType("SCREEN_BROADCAST"), CommandType::SCREEN_BROADCAST);
...
TEST_F(ProtocolTest, StringToCommandTypeInvalid) {
    ...
    EXPECT_THROW(StringToCommandType("hello"), std::invalid_argument); // case sensitive
}
...
TEST_F(ProtocolTest, SerializeHelloMessage) {
    ...
    auto msg = Message::Create(CommandType::HELLO, "client-001", "master", payload);
...
TEST_F(ProtocolTest, SerializeDeserializeIdempotency) {
    ...
    auto original = Message::Create(CommandType::SCREENSHOT_REQUEST, "master", "client-001", payload);
...
TEST_F(ProtocolTest, IdempotencyAllCommandTypes) {
    ...
    std::vector<CommandType> types = {
        CommandType::HELLO, CommandType::PING, CommandType::DISCONNECT
    };
...
TEST_F(ProtocolTest, ValidateDetectsPayloadModification) {
    ...
    auto msg = Message::Create(CommandType::STATUS_UPDATE, "client", "master", payload);
...
TEST_F(ProtocolTest, RealisticHelloHandshake) {
    ...
    auto hello_msg = Message::Create(CommandType::HELLO, "client-001", "master", hello_payload);
...
TEST_F(ProtocolTest, RealisticScreenshotFlow) {
    ...
    auto request = Message::Create(CommandType::SCREENSHOT_REQUEST, "master", "client-001", request_payload);
    ...
    auto response = Message::Create(CommandType::SCREENSHOT_DATA, "client-001", "master", data_payload);
...
TEST_F(ProtocolTest, RealisticDomainBlockCommand) {
    ...
    auto msg = Message::Create(CommandType::DOMAIN_BLOCK, "master", "client-001", block_payload);
    auto json_str = serializer.Serialize(msg);
...
TEST_F(ProtocolTest, RealisticStatusUpdate) {
    ...
    auto msg = Message::Create(CommandType::STATUS_UPDATE, "client-001", "master", status_payload);
    auto json_str = serializer.Serialize(msg);
