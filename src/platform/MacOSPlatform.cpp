...
public:
    ...
    float getScreenScaleFactor() override {
        // TODO: Use NSScreen backingScaleFactor
    ...
    ScreenImage captureScreen() override {
        ...
        // TODO: Use Core Graphics CGDisplayCreateImage()
        return ScreenImage{};
    }
    ...
    PowerStatus getPowerStatus() override {
        PowerStatus status;
        // TODO: Use IOKit for battery status
    ...
    bool blockDomains(const std::vector<std::string>& domains) override {
        ...
        // TODO: Use Network Extension framework
        return false;
    }
