...
inline std::string CommandTypeToString(CommandType type) {
    switch (type) {
        ...
        case CommandType::SCREENSHOT_REQUEST: return "SCREENSHOT_REQUEST";
        case CommandType::SCREENSHOT_DATA: return "SCREENSHOT_DATA";
        case CommandType::SCREEN_LOCK: return "SCREEN_LOCK";
        case CommandType::SCREEN_UNLOCK: return "SCREEN_UNLOCK";
        case CommandType::SCREEN_BROADCAST: return "SCREEN_BROADCAST";
        case CommandType::POWER_CONTROL: return "POWER_CONTROL";
        case CommandType::DOMAIN_BLOCK: return "DOMAIN_BLOCK";
        case CommandType::DOMAIN_ALLOW: return "DOMAIN_ALLOW";
        case CommandType::STATUS_UPDATE: return "STATUS_UPDATE";
...
inline CommandType StringToCommandType(const std::string& str) {
    if (str == "HELLO") return CommandType::HELLO;
    if (str == "SCREENSHOT_REQUEST") return CommandType::SCREENSHOT_REQUEST;
    if (str == "SCREENSHOT_DATA") return CommandType::SCREENSHOT_DATA;
    if (str == "SCREEN_LOCK") return CommandType::SCREEN_LOCK;
    if (str == "SCREEN_UNLOCK") return CommandType::SCREEN_UNLOCK;
    if (str == "SCREEN_BROADCAST") return CommandType::SCREEN_BROADCAST;
    if (str == "POWER_CONTROL") return CommandType::POWER_CONTROL;
    if (str == "DOMAIN_BLOCK") return CommandType::DOMAIN_BLOCK;
    if (str == "DOMAIN_ALLOW") return CommandType::DOMAIN_ALLOW;
    if (str == "STATUS_UPDATE") return CommandType::STATUS_UPDATE;
